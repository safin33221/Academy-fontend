...
export default function HeroSection() {
    return (
        <section className="relative max-md:py-20 md:min-h-screen flex items-center justify-center overflow-hidden bg-linear-to-br from-slate-50 via-white to-slate-100
